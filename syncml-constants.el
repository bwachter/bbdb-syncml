;; This file just contains a list of SyncML constants -*- lexical-binding: t; -*-
...
(defconst syncml-alert-display 100
  "SyncML <ALERT> Code: Show. The Data element type contains content information
that should be processed and displayed through the user agent.")
...
(defconst syncml-alert-one-way-from-client "202"
  "SyncML <ALERT> Code: Specifies the client-initiated, one-way only sync from
the client to the server.")
(defconst syncml-alert-refresh-from-client "203"
  "SyncML <ALERT> Code: Specifies the client-initiated, refresh operation for
the oneway only sync from the client to the server.")
(defconst syncml-alert-one-way-from-server "204"
  "SyncML <ALERT> Code: Specifies the client-initiated, one-way only sync from
the server to the client.")
(defconst syncml-alert-refresh-from-server "205"
  "SyncML <ALERT> Code: Specifies the client-initiated, refresh operation of the
oneway only sync from the server to the client.")
...
(defconst syncml-alert-one-way-from-client-by-server "207"
  "SyncML <ALERT> Code: Specifies the server-initiated, one-way only sync from
the client to the server.")
(defconst syncml-alert-refresh-from-client-by-server "208"
  "SyncML <ALERT> Code: Specifies the server-initiated, refresh operation for
the one-way only sync from the client to the server.")
(defconst syncml-alert-one-way-from-server-by-server "209"
  "SyncML <ALERT> Code: Specifies the server-initiated, one-way only sync from
the server to the client.")
(defconst syncml-alert-refresh-from-server-by-server "210"
  "SyncML <ALERT> Code: Specifies the server-initiated, refresh operation of the
 oneway only sync from the server to the client.")
